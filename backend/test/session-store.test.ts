...
import { InterviewState, InterviewStage } from "../src/interview/types";

function makeBaseState(sessionId: string): InterviewState {
...
(function run() {
  ...
  // update
  const updated = { ...s1, questionCount: 1, updatedAt: new Date().toISOString() } as InterviewState;
